...
for np in 32; do
    echo "Running with $np processes..."
    python3 profile.py --csv parallel_execution_timesITER1000.csv mpirun -np $np -hostfile ./../../../build/hostfile  ./../../../build/fractal_mpi -i 1000 -s 16 --output_disabled -w 1080  -h 1080 -b 32
